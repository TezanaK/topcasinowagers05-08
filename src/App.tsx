...
function App() {
  ...
  const topCasinos: Casino[] = [
    ...
    },
    {
      ...
      link: "https://neospinlink.com/hd5377aa9",
      payoutTime: "1-2 days",
      minDeposit: "CA$20",
      games: 1200,
      license: "Curacao Gaming License",
                  ...
                  <div className="grid lg:grid-cols-4 gap-8 items-center">
                    ...
                    <div className="lg:col-span-1">
                      <div className="space-y-3">
                        ...
                        <button className="w-full glass rounded-2xl py-3 font-semibold text-slate-700 border border-slate-200 hover:bg-slate-50 transition-colors">
                          <div className="flex items-center justify-center">
